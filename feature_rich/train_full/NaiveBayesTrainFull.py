...
(male_fpr_plco, male_tpr_plco, male_auc_plco), (male_fpr_ukb, male_tpr_ukb, male_auc_ukb), male_plco_train_metrics, male_ukb_metrics = train_evaluate_model(male_plco_path, male_ukb_path, GaussianNB, 'Naive Bayes (Male): Training Loss', 'ML Models/Models (Feature Rich)/feature_rich_full_plco_train/feature_rich_full_train_photos/NaiveBayesFeatureRichFullTrainMaleLoss.png')

(female_fpr_plco, female_tpr_plco, female_auc_plco), (female_fpr_ukb, female_tpr_ukb, female_auc_ukb), female_plco_train_metrics, female_ukb_metrics = train_evaluate_model(female_plco_path, female_ukb_path, GaussianNB, 'Naive Bayes (Female): Training Loss', 'ML Models/Models (Feature Rich)/feature_rich_full_plco_train/feature_rich_full_train_photos/NaiveBayesFeatureRichFullTrainFemaleLoss.png')
...
plot_auc(male_fpr_plco, male_tpr_plco, male_auc_plco,
             ...
             female_fpr_plco, female_tpr_plco, female_auc_plco,
             female_fpr_ukb, female_tpr_ukb, female_auc_ukb,
             filename='ML Models/Models (Feature Rich)/feature_rich_full_plco_train/feature_rich_full_train_photos/NaiveBayesFeatureRichFullTrain.png',
             title='Naive Bayes: ROC Curves for Lung Cancer Prediction (FT)')