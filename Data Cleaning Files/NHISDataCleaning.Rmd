...
library(dplyr)
NHIS_Edit <- NHISdata %>% select(-YEAR, -SERIAL, -STRATA, -PSU, -NHISHID, -HHWEIGHT, -PERNUM, -NHISPID, -HHX, -FMX, -PX, -PERWEIGHT, -SAMPWEIGHT, -LONGWEIGHT, -PARTWEIGHT, -FWEIGHT, -SUPP1WT, -SUPP2WT, -ASTATFLG, -CSTATFLG)
