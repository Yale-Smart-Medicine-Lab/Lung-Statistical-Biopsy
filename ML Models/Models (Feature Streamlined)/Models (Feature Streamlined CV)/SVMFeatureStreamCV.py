...
plt.title('SVM: ROC Curves for Lung Cancer Prediction (70%) CV')
plt.legend(loc='lower right')
plt.savefig('/Users/teresanguyen/Lung-Statistical-Biopsy/ML Models/Models (Feature Streamlined)/Models (Feature Streamlined CV)/feature streamlined cv photos/SVMFStreamlinedCv70.png', dpi=300, bbox_inches='tight')
plt.show()
