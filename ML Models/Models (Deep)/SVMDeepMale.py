...
plt.title('PLCO Male: ROC curve (Support Vector Machines)')
plt.legend(loc='lower right')
plt.savefig('male_lung_ROC_SVM.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.xlabel('False positive rate (Specificity)')
plt.ylabel('True positive rate (Sensitivity)')
plt.title('Male Lung Cancer UK Biobank Testing: ROC curve (Support Vector Machines)')
plt.legend(loc='lower right')
plt.savefig('maleCancerROCUKBiobank_SVM.png', dpi=300, bbox_inches='tight')
plt.show()