...
plt.title('PLCO Shallow Female: ROC curve (SVM)')
plt.legend(loc='lower right')
plt.savefig('PLCO_female_lung_ROC_SVM_shallow.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.title('UKB Shallow Female: ROC curve (SVM)')
plt.legend(loc='lower right')
plt.savefig('UKB_female_lung_ROC_SVM_shallow.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.xlabel('False positive rate')
plt.ylabel('True positive rate')
plt.title('NHIS Shallow Female: ROC curve (SVM)')
plt.legend(loc='lower right')
plt.savefig('NHIS_female_lung_ROC_SVM_shallow.png', dpi=300, bbox_inches='tight')
plt.show()