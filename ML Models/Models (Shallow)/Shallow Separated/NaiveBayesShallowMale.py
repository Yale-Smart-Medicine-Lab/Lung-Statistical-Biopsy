...
# Load NHIS data to determine common features (Mean Imputation)
# nhis_data = pd.read_csv('Data Files/female_filtered_70_NHIS_mean_imputed.csv')
# nhis_data = pd.read_csv('Data Files/male_filtered_30_NHIS_mean_imputed.csv')
# nhis_data = pd.read_csv('Data Files/male_filtered_chosen_NHIS_mean_imputed.csv')
...
plt.title('PLCO Shallow Male: ROC curve (NB)')
plt.legend(loc='lower right')
plt.savefig('PLCO_male_lung_ROC_NB_shallow.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.title('UKB Shallow Male: ROC curve (NB)')
plt.legend(loc='lower right')
plt.savefig('UKB_male_lung_ROC_NB_shallow.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.xlabel('False positive rate')
plt.ylabel('True positive rate')
plt.title('NHIS Shallow Male: ROC curve (NB)')
plt.legend(loc='lower right')
plt.savefig('NHIS_male_lung_ROC_NB_shallow.png', dpi=300, bbox_inches='tight')
plt.show()