...
plt.title('PLCO Shallow Male: ROC curve (RF)')
plt.legend(loc='lower right')
plt.savefig('PLCO_male_lung_ROC_RF_shallow.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.title('UKB Shallow Male: ROC curve (RF)')
plt.legend(loc='lower right')
plt.savefig('UKB_male_lung_ROC_RF_shallow.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.xlabel('False positive rate')
plt.ylabel('True positive rate')
plt.title('NHIS Shallow Male: ROC curve (RF)')
plt.legend(loc='lower right')
plt.savefig('NHIS_male_lung_ROC_RF_shallow.png', dpi=300, bbox_inches='tight')
plt.show()