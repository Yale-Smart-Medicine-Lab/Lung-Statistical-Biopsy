...
plt.title('Naive Bayes: ROC Curves for Lung Cancer Prediction (FT)')
plt.legend(loc='lower right')
plt.savefig('ML Models/Models (Feature Rich)/feature_rich_full_plco_train/feature_rich_full_train_photos/NaiveBayesFeatureRichFullTrain.png', dpi=300, bbox_inches='tight')
plt.show()