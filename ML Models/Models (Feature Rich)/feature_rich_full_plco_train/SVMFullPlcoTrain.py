...
plt.title('Support Vector Machines: ROC Curves for Lung Cancer Prediction (FT)')
plt.legend(loc='lower right')
plt.savefig('ML Models/Models (Feature Rich)/feature_rich_full_plco_train/feature_rich_full_train_photos/SVMFullTrain.png', dpi=300, bbox_inches='tight')
plt.show()
