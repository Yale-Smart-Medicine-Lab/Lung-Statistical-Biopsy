...
# Load UKB data
cancers = ['lung']
data = pd.read_csv('/Users/teresanguyen/Documents/Lung-Statistical-Biopsy/Data Files/UKB_female_Lung_Imputed_MAIN.csv')
...
plt.xlabel('False positive rate (Specificity)')
plt.ylabel('True positive rate (Sensitivity)')
plt.title('Female Lung Cancer UK Biobank Testing: ROC curve (Neural Network)')
plt.legend(loc='lower right')
