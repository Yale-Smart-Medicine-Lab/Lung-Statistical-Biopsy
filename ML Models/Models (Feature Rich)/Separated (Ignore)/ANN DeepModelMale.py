...
# Load PLCO male data
plco_data = pd.read_csv('/Users/teresanguyen/Documents/Lung-Statistical-Biopsy/Data Files/PLCO_male_Lung_Data_MAIN_imputed.csv')
...
# Define the model for male data
...
plt.plot(fpr_plco, tpr_plco, label=f'PLCO Male (AUC = {auc_plco:.3f})')
plt.plot(fpr_ukb, tpr_ukb, label=f'UKB Male (AUC = {auc_ukb:.3f})')
plt.xlabel('False Positive Rate')
plt.ylabel('True Positive Rate')
plt.title('Neural Network: ROC Curves for Male Lung Cancer Prediction')
