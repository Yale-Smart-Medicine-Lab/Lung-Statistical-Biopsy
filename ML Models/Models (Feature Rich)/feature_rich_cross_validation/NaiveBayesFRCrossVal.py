...
male_cv_means, male_cv_stds, (male_fpr_plco, male_tpr_plco, male_auc_plco), (male_fpr_ukb, male_tpr_ukb, male_auc_ukb), male_plco_train_metrics, male_ukb_metrics, male_loss_curves = cross_validate_and_train(male_plco_path, male_ukb_path)

# Perform cross-validation and training for female data
female_cv_means, female_cv_stds, (female_fpr_plco, female_tpr_plco, female_auc_plco), (female_fpr_ukb, female_tpr_ukb, female_auc_ukb), female_plco_train_metrics, female_ukb_metrics, female_loss_curves = cross_validate_and_train(female_plco_path, female_ukb_path)
...
plt.ylabel('Log Loss')
plt.title('Naive Bayes: Loss Curves for Cross-Validation Folds')
plt.legend(loc='upper right', fontsize='small', framealpha=0.5)
plt.savefig('ML Models/Models (Feature Rich)/feature_rich_cross_validation/feature_rich_cv/NaiveBayesFeatureRichLossCurves.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.savefig('ML Models/Models (Feature Rich)/feature_rich_cross_validation/feature_rich_cv/NaiveBayesFeatureRichROCCurves.png', dpi=300, bbox_inches='tight')
plt.show()
