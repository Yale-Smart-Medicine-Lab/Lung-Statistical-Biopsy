...
The model is trained on the PLCO data and evaluated on the PLCO test set and the UKB data.
Functions: 
...
plt.savefig('ML Models/Models (Feature Rich)/Feature Rich Photos/LogRegFeatureRich.png', dpi=300, bbox_inches='tight')
plt.show()
